...
MODEL           = modello_2017b_levaRetro_acc
MODULES         = rt_matrx.c rt_printf.c rt_logging.c modello_2017b_levaRetro_acc_capi.c modello_2017b_levaRetro_acc_data.c modello_2017b_levaRetro_acc_xcp.c modello_2017b_levaRetro_acc_xcp_TET.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c ecat_config_xml_0.c rt_logging_mmi.c rtw_modelmap_utils.c host_timer_x86.c xpc_code_profiling_utility_functions.c
MAKEFILE        = modello_2017b_levaRetro_acc.mk
...
S_FUNCTIONS     = slrtUDPReceive.c slrtUDPSend.c xpcethercatgetstate.c xpcethercatpdorx.c xpcethercatpdotx.c xpcethercatsetstate.c
S_FUNCTIONS_LIB = 
NUMST           = 5
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = modello_2017b_levaRetro_acclib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = modello_2017b_levaRetro_acc_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\modello_2017b_levaRetro_acc_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\Ronda\Desktop\AsiaHapticsDemo\Cambio\modello_current
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
