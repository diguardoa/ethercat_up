...
MODULES                 = rt_matrx.c rt_printf.c AcquireAngleAmicSimple_4kHz_M2017b_data.c RTGETINF.C RTGETNAN.C rt_nonfinite.c ecat_config_xml_0.c
...
MASTER_ANCHOR_DIR       = 
START_DIR               = D:\Dropbox\Dropbox\AsiaHaptics_CODE\Acqusizione_AMIC
S_FUNCTIONS             = xpcethercatgetstate.c xpcethercatpdorx.c xpcethercatpdotx.c xpcethercatsetstate.c xpctimeinfo.c
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 0
BUILDARGS               =  GENERATE_ASAP2=0 OPTS="-DRT -DUSE_RTMODEL -DERT -DTID01EQ=1"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
GEN_SAMPLE_MAIN         = 1
TARGET_LANG_EXT         = c
MEX_OPT_FILE            = -f "C:\Users\exo-hand-pc\AppData\Roaming\MathWorks\MATLAB\R2017b\mex_C_win64.xml"
COMPUTER                = PCWIN64
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\AcquireAngleAmicSimple_4kHz_M2017b_ert_rtw
...
!if $(INTEGER_CODE) == 0
!if "$(MODELREF_TARGET_TYPE)" == "SIM"
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\lib\AtEcat_xpc_rtwsfcn_vcx64.lib
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\lib\AtEcat_xpc_ert_vcx64.lib
!endif
!else
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\lib\AtEcat_xpc_int_ert_vcx64.lib
!endif
!else
